...
@Component({
  selector: 'app-houblon',
  templateUrl: './houblon.component.html',
  styleUrls: ['./houblon.component.scss']
})

export class HoublonComponent implements OnInit {
  ...
  ngOnInit() {
    console.log("XXXX  HoublonComponent => ngOnInit() : ingredients", this.ingredients);
  }
